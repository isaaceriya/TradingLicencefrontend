...
const summaryRules = [
    { required: true, message: 'Please Enter The Issue' }   
];
...
/**
 * Contactform form component for app signup.
 ...
 */
  onFinish = (values) => {
    ...
    fetch('https://sardine-shock-3000.codio-box.uk/api/v1/messages', {
        method: "POST",
...
// To store in the database, a label to show and rules to validate
  render() {
    return (
      ...
      <h1 className='my-h1-landing'> Contact Us</h1>
        
        <Form.Item name="title" label="Company Name" rules={titlesRules} >
            <Input />
        </Form.Item>

        <Form.Item name="imageURL" label="Email" rules={imageurlRules} >
            <Input />
        </Form.Item>



        <Form.Item name="summary" label="Type of issue" rules={summaryRules} >
            <Input />
        </Form.Item>
